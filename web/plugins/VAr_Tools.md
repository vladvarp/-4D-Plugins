...
::::tabs
### Animation
| Значок | Плагин | Описание | Подробнее |
| ------ | ------ | -------- | --------- |
...
| [[ico:'ico/Var_tools/Tools/Clean/Clean_AnimationKeys.png']]  | **Clean Animation Keys** | Удаляет ключевые кадры анимации сцены. Предлагает выбор: все ключевые кадры сцены, только выделенного объекта, или выделенного объекта и всех его дочерних объектов рекурсивно. |
::::
...
| [[ico:'ico/Var_tools/Objects/Primitivs/MolecularHexLattice.png']] | **Molecular Hex Lattice** | Генератор молекулярных связей с автоматическими тегами материалов: **M** — шары, **T** — трубки, **F** — фаски. | [[mdb:'Превью'-n'MolecularHexLattice'-b8]] |
| [[ico:'ico/Var_tools/Objects/Primitivs/Tesseract.png']]           | **Tesseract** | Генератор тессеракта (4D гиперкуб) с проекцией в 3D. Автоматические теги материалов: **K** — каркас, **P** — вершины, **C** — ячейки. | [[mdb:'Превью'-n'Tesseract'-b8]] |
| [[ico:'ico/Var_tools/Objects/Primitivs/Diamond.png']]             | **Diamond** | Параметрический драгоценный камень с 30 видами огранки. | [[mdb:'Огранки'-n'Diamond'-b8]] |
| [[ico:'ico/Var_tools/Objects/Primitivs/GeodesicDome.png']]        | **Geodesic Dome** | Параметрический геодезический купол. | [[mdb:'Типы'-n'GeodesicDome'-b8]] |
...
| Значок | Плагин | Описание | Подробнее |
| ------ | ------ | -------- | --------- |
| [[ico:'ico/Var_tools/Objects/XPressos_objects/HierarchyFilter.png']] | **Hierarchy Filter** | Объект-Ноль с расширенными UserData для фильтрации и обхода иерархии. Используется совместно с Xpresso для динамической выборки дочерних объектов. | [[mdb:'UI'-n'HierarchyFilter'-b8]] |
::::
...
| Значок | Плагин | Описание | Подробнее |
| ------ | ------ | -------- | --------- |
| [[ico:'ico/Var_tools/Tegs/ChildSelectorTeg.png']]    | **Child Selector Teg** | Добавляет на объект дропдаун выбора прямого дочернего объекта; автоматически обновляет поля «Имя» и «Связь» при смене выбора. | [[mdb:'UI'-n'ChildSelectorTeg'-b8]] |
...
| [[ico:'ico/Var_tools/Tegs/CameraVisibilityTag.png']] | **Camera Visibility Tag** | Тег управляет видимостью объекта (вьюпорт + рендер) в зависимости от активной камеры сцены (Stage-объект). | [[mdb:'UI'-n'CameraVisibilityTag'-b8]] |
::::
...
| Значок | Плагин | Описание | Подробнее |
| ------ | ------ | -------- | --------- |
| [[ico:'ico/Var_tools/Deformers/PolySubdivide.png']] | **Poly Subdivider** | Эксперементальный аналог Divider: несколько алгоритмов разбиения полигонов с возможностью лёгкого добавления новых типов. | [[mdb:'UI'-n'PolySubdivide'-b8]] |
::::
...
♦ Подразделения X      [["6"]]  [[tif:'3'-t'0'-s110-sc180-d1/20-st1]]
♦ Подразделения Y      [["6"]]  [[tif:'3'-t'0'-s110-sc180-d1/20-st1]]
♦ Подразделения Z      [["6"]]  [[tif:'3'-t'0'-s110-sc180-d1/20-st1]]
♦ Поверхность          [["14"]] [[ddl:'Треугольники','Квады','Ёлочка','Смещённые ряды','Гексагоны'-s300-p1]]
♦ Смещение (звезда)    [["3"]]  [[biil:-c0-r1]]
♦ Величина смещения    [["1"]]  [[tif:'0'-t'0'-p'cm'-s80-sc180-d0/50-st1]]
...
♦ Подразделения  [["5"]]  [[tif:'2'-t'0'-s110-sc200-d1/5]]
♦ углов          [["23"]] [[tif:'6'-t'0'-s110-sc200-d3/16]]
::::
</mdc>
...
♦ Сегменты (окружность)    [["6"]]  [[tif:'12'-t'0'-s110-sc120-d3/50]]
♦ Сегменты (высота)        [["14"]] [[tif:'6'-t'0'-s110-sc120-d3/50]]
♦ Крышки                   [["35"]] [[biil:-c1-r1]]
♦ Тип поверхности          [["18"]] [[ddl:'Зигзаг (ромбы)','Спираль','Гармошка','Прямая сетка'-s250-p1]]
♦ Скрутка                  [["33"]] [[tif:'0'-t'0'-p'°'-s80-sc120-d-180/180]]
♦ Смещение (звезда)        [["14"]] [[biil:-c0-r1]]
♦ Величина смещения        [["11"]] [[tif:'20'-t'0'-p'cm'-s80-sc120-d-50/150]]
::::
</mdc>
...
♦ Радиус (большой)         [["6"]]  [[tif:'150'-t'0'-p'cm'-s80-sc180-d10/300-st1]]
♦ Радиус (малый)           [["10"]] [[tif:'50'-t'0'-p'cm'-s80-sc180-d1/100-st1]]
♦ Сегменты (кольцо)        [["4"]]  [[tif:'24'-t'0'-s110-sc180-d3/100-st1]]
♦ Сегменты (труба)         [["6"]]  [[tif:'12'-t'0'-s110-sc180-d3/100-st1]]
♦ Тип поверхности          [["7"]]  [[ddl:'Квадратная','Треугольная','Спиральная','Диагональная'-s250-p1]]

### ДЕФОРМАЦИИ

♦ Кручение (Twist)         [["8"]]  [[tif:'0'-t'0'-p'°'-s87-sc180-d-90/90-st1]]
♦ Сужение X (Taper)        [["5"]]  [[tif:'0'-t'0.0'-s110-sc180-d-2/2-st0.01]]
♦ Сужение Y (Taper)        [["5"]]  [[tif:'0'-t'0.0'-s110-sc180-d-2/2-st0.01]]
♦ Масштаб X                [["18"]] [[tif:'1'-t'0.0'-s110-sc180-d0.01/10-st0.01]]
♦ Масштаб Y                [["18"]] [[tif:'1'-t'0.0'-s110-sc180-d0.01/10-st0.01]]
♦ Масштаб Z                [["18"]] [[tif:'1'-t'0.0'-s110-sc180-d0.01/10-st0.01]]

### СМЕЩЕНИЕ ПОВЕРХНОСТИ

♦ Тип смещения             [["15"]] [[ddl:'Нет','Синусоида','Шум Перлина','Радиальное'-s250-p1]]
♦ Амплитуда                [["21"]] [[tif:'0'-t'0'-p'cm'-s80-sc165-d0/50-st1]]
♦ Частота                  [["26"]] [[tif:'0.1'-t'0.0'-s110-sc165-d0.001/10-st0.001]]
♦ Фаза (анимировать)       [["5"]]  [[tif:'0'-t'0.0'-s110-sc165-d0/10-st0.01]]
♦ Октавы шума              [["16"]] [[tif:'4'-t'0'-s110-sc165-d1/8-st1]]
♦ Лакунарность             [["15"]] [[tif:'2'-t'0.0'-s110-sc165-d1/8-st0.1]]
♦ Усиление (Gain)          [["12"]] [[tif:'0.5'-t'0.0'-s110-sc165-d0.01/2-st0.01]]

### СПИРАЛЬ

♦ Количество витков        [["5"]]  [[tif:'1'-t'0'-s110-sc165-d0/10-st1]]
♦ Направление              [["15"]] [[ddl:'По часовой','Против часовой'-s250-p1]]

### ФОНГ

♦ Угол фонга               [["17"]] [[tif:'180'-t'0'-p'°'-s80-sc180-d0/180-st1]]
...
♦ Рядов (X)                [["20"]] [[tif:'4'-t'0'-s110-sc180-d1/50-st1]]
♦ Рядов (Y)                [["20"]] [[tif:'4'-t'0'-s110-sc180-d1/50-st1]]
♦ Тип поверхности          [["7"]]  [[ddl:'Кирпич (1/2)','Кирпич (стек)','Кирпич (1/3)','Ёлочка','Гексагональные','Корзинка'-s200-p1]]
♦ Скрутка (°)              [["17"]] [[tif:'0'-t'0'-p'cm'-s80-sc180-d0/100-st1]]
♦ Величина смещения        [["1"]]  [[tif:'0'-t'0.0'-s110-sc180-d0/0.4-st0.005]]
::::
</mdc>
...
♦ Плотность (шаг сетки)        [["14"]] [[tif:'200'-t'0'-p'cm'-s80-sc110-d10/500]]
♦ Макс. длина связи            [["21"]] [[tif:'250'-t'0'-p'cm'-s80-sc110-d10/400]]
♦ Seed                         [["45"]] [[tif:'0'-t'0'-s110]]
♦ Джиттер (шум позиций)        [["11"]] [[tif:'0'-t'0'-p'cm'-s80-sc110-d10/500]]
♦ Скрывать одиночные шары      [["5"]]  [[biil:-c1-r1]]

### STRIP - ВОЛНОВОЕ СМЕЩЕНИЕ

♦ Амплитуда                    [["22"]] [[tif:'0'-t'0'-p'cm'-s80-sc160-d0/500]]
♦ Частота                      [["27"]] [[tif:'0.01'-t'0.0'-s110-sc160-d0.1/10-st0.001]]
♦ Фаза (анимировать)           [["5"]]  [[tif:'0'-t'0.1'-s110-sc160-d-10/10-st0.01]]
♦ Ось волны                    [["22"]] [[ddl:'X (смещение Y)','Y (смещение X)','Z (смещение Y)'-s200-p2]]

### ШАРЫ [M]

♦ Радиус шара                  [["10"]] [[tif:'35'-t'0'-p'cm'-s80-sc200-d10/100]]
♦ Подразделение                [["5"]]  [[tif:'1'-t'0'-s110-sc200-d1/4]]
♦ Фонг шаров                   [["11"]] [[tif:'35'-t'0'-p'°'-s86-sc200-d0/180]]

### ТРУБКИ [T]

♦ Радиус трубки                [["19"]] [[tif:'6'-t'0.5'-p'cm'-s80-sc150-d0.5/100-st0.5]]
♦ Сегменты окружности          [["5"]]  [[tif:'9'-t'0'-s110-sc150-d3/18]]
♦ Сегменты длины               [["15"]] [[tif:'2'-t'0'-s110-sc150-d1/20]]

### ФАСКА [F]

♦ Размер фаски                 [["20"]] [[tif:'3'-t'0'-p'cm'-s80-sc150-d1/30]]
♦ Подразделение фаски          [["5"]]  [[tif:'0'-t'0'-s110-sc150-d0/8]]
::::
:::info
**Материальные группы**

При генерации автоматически создаются теги выделения полигонов для назначения материалов:

| Тег | Имя | Область | Описание |
| --- | --- | --- | --- |
| **M** | Шары | `Шары [M]` | Все полигоны молекулярных шаров (dual icosphere). Группа «Шары» в настройках управляет геометрией. |
| **T** | Трубки | `Трубки [T]` | Боковая поверхность цилиндров-связей между шарами. Группа «Трубки» управляет радиусом и сегментами. |
| **F** | Фаски | `Фаска [F]` | Скругления на стыке шар↔трубка. Группа «Фаска» управляет размером и подразделением. |

**Как использовать:** назначь материал на объект Molecular Hex Lattice, добавь тег ограничения выделения и выбери нужное имя (M, T или F).
:::
</mdc>
...
[[p:'image\var_tools\Objects\Primitivs\Tesseract\3.png']]
[[p:'image\var_tools\Objects\Primitivs\Tesseract\4.png']]
===
---
...
♦ Поворот XY               [["6"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]
♦ Поворот XZ               [["6"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]
♦ Поворот XW               [["5"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]
♦ Поворот YZ               [["6"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]
♦ Поворот YW               [["5"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]
♦ Поворот ZW               [["5"]]  [[tif:'0'-t'0'-p'°'-sc200-d-360/360-s80]]

### АВТОВРАЩЕНИЕ

♦ Включить                 [["12"]] [[biil:-c0-r1]]
♦ Скорость XY              [["6"]]  [[tif:'0'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Скорость XZ              [["6"]]  [[tif:'0'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Скорость XW              [["5"]]  [[tif:'0'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Скорость YZ              [["6"]]  [[tif:'0'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Скорость YW              [["5"]]  [[tif:'0'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Скорость ZW              [["5"]]  [[tif:'1'-t'0.0'-sc200-d-5/5-st0.1-s110]]
♦ Фаза                     [["20"]] [[tif:'0'-t'0'-sc200-d-4/4-st0.01-s110]]

### ВИЗУАЛ

♦ Радиус рёбер             [["12"]] [[tif:'5'-t'0'-p'cm'-sc180-d5/100-s80]]
♦ Сегменты рёбер           [["7"]]  [[tif:'9'-t'0'-sc180-d3/16-s110]]
♦ Радиус вершин            [["9"]]  [[tif:'10'-t'0.0'-p'cm'-sc180-d0.1/200-s80]]
♦ Сегменты вершин          [["4"]]  [[tif:'8'-t'0'-sc180-d3/16-s110]]
...
| Тег | Имя | Область | Описание |
| --- | --- | --- | --- |
| **K** | Каркас | `Edges` | Рёбра-цилиндры тессеракта (32 ребра 4D-гиперкуба). Группа «Визуал» управляет радиусом и сегментами. |
| **P** | Вершины | `V_00`–`V_15` | Сферы на 16 вершинах тессеракта. |
| **C** | Ячейки | `Cell_0`–`Cell_7` | Грани 8 ячеек (кубов) 4D-гиперкуба. Видны в режимах «Ячейки» и «Всё». |

**Как использовать:** назначь материал на объект Tesseract, добавь тег ограничения выделения и выбери нужное имя (K, P или C).
:::
</mdc>
...
[[p:'image\var_tools\Objects\Primitivs\Diamond\18.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\19.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\20.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\21.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\22.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\23.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\24.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\25.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\26.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\27.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\28.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\29.png']]
[[p:'image\var_tools\Objects\Primitivs\Diamond\30.png']]
===
---
...
♦ Огранка              [["23"]] [[ddl:'Бриллиант (Круглая)','Бриллиант (Квадратная)','Принцесса (Квадратная)','Изумруд (Ступенчатая)','Маркиза (Навет)','Груша (Teardrop)','Овал','Кушон (Подушка)','Ашер (Квадрат-ступени)','Сердце','Роза (Старинная)','Триллион (Треугольный)','Ромб (Lozenge)','Кайт (Kite)','Бриолетт (Briolette)','Гроб (Coffin)','Звезда (Star)','Цветок (Flower)','Крест (Cross)','Лист (Leaf)','Стрела (Arrow)','Бабочка (Butterfly)','Кельтский (Celtic)','Корона (Crown)','Дракон (Dragon)','Снежинка (Snowflake)','Спираль (Spiral)','Роза (Rose Window)','Лотос (Lotus)','Пламя (Flame)'-s200]]
...
♦ Площадка             [["19"]] [[tif:'55'-t'0'-p'%'-s85-sc250-d5/95-st1]]
♦ Калета               [["25"]] [[tif:'0'-t'0'-p'%'-s85-sc250-d0/30-st1]]
♦ Ступени              [["22"]] [[tif:'2'-t'0'-s110-sc250-d2/5-st1]]
::::
</mdc>
<mdc-n'GeodesicDome'-s600*500>
icon: ico/Var_tools/Objects/Primitivs/GeodesicDome.png
title: Geodesic Dome
===photo -s500*300 -c2 -asc1000 -asp1000
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\1.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\2.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\3.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\4.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\5.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\6.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\7.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\8.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\9.png']]
[[p:'image\var_tools\Objects\Primitivs\GeodesicDome\10.png']]
===
---

## Интерфейс

♦ Тип покрытия         [["13"]] [[ddl:'Triangles (Классический)','Hexagons (Соты)','Quads (Квадраты)','Spiral (Спираль / Phyllotaxis)','Voronoi (Органические ячейки)','Diamond (Ромбы)','Bricks (Кирпичная кладка)','Pentagons (Пятиугольники)','Triacon (Трикон / Двойник)','Weave (Плетение)'-s325-p1]]
♦ Частота              [["23"]] [[tif:'3'-t'0'-s110-sc200-d1/8]]
♦ Радиус               [["24"]] [[tif:'200'-t'0'-p'cm'-s80-sc200-d10/1000-st5]]
♦ Угол среза           [["18"]] [[tif:'50'-t'0'-p'%'-s85-sc200-d0/100-st1]]
♦ Режим                [["25"]] [[ddl:'Dome (Купол)','Full Sphere (Полная сфера)','Drum (На барабане)','Elliptic Dome (Эллипс)'-s325-p1]]
♦ Высота барабана      [["7"]]  [[tif:'50'-t'0'-p'cm'-s80-sc200-d0/500-st1]]
::::details-open
Опции
♦ Инвертировать (вогнутый)   [["2"]]  [[biil:-c0-r1]] [["1"]]  ♦ Phong-сглаживание  [["3"]]  [[biil:-c0-r1]]
♦ Открытое основание         [["12"]] [[biil:-c0-r1]] [["1"]]  ♦ Плоская заглушка   [["7"]]  [[biil:-c1-r1]]
::::
</mdc>


<mdc-n'PolySubdivide'-s700*500>
icon: ico/Var_tools/Deformers/PolySubdivide.png
title: Poly Subdivide
===photo -s500*300 -c2 -asc1000 -asp1000
[[p:'image\var_tools\Deformers\PolySubdivide\1.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\2.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\3.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\4.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\5.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\6.png']]
[[p:'image\var_tools\Deformers\PolySubdivide\7.png']]
===
---

Экспериментальный деформер-генератор, разбивающий полигоны дочернего объекта по одному из 6 алгоритмов. Работает как генератор: помести под объект и настрой алгоритм.
...
♦ Алгоритм             [["27"]] [[ddl:'Равномерное','Случайное','Диагональ','Ёлочка','Радиальное','Вороной'-s220]]
♦ Итерации             [["27"]] [[tif:'3'-t'0'-s110-sc250-d1/8]]
♦ Смещение X           [["22"]] [[tif:'18'-t'0'-p'%'-s85-sc250-d0/100]]
♦ Смещение Y           [["22"]] [[tif:'35'-t'0'-p'%'-s85-sc250-d0/100]]
♦ Смещение Z           [["22"]] [[tif:'50'-t'0'-p'%'-s85-sc250-d0/100]]
♦ Угол паттерна        [["20"]] [[tif:'0'-t'0'-p'°'-s85-sc250-d-180/180]]
♦ Зерно случайности    [["10"]] [[tif:'0'-t'0'-s110-sc250-d0/100]]

### ШУМ

♦ Величина шума        [["16"]] [[tif:'0.5'-t'0.0'-s110-sc250-d0/50-st0.1]]
♦ Частота шума         [["19"]] [[tif:'3.0'-t'0.0'-s110-sc250-d01/20-st001]]
♦ Петля шума           [["23"]] [[tif:'0'-t'0.0'-p'%'-s85-sc250-d0/100]]
::::
</mdc>


<mdc-n'HierarchyFilter'-s600*500>
icon: ico/Var_tools/Objects/XPressos_objects/HierarchyFilter.png
title: Hierarchy Filter
tagline: Объект-Ноль с расширенными UserData для фильтрации и обхода иерархии. Используется совместно с Xpresso для динамической выборки дочерних объектов.
...
## Интерфейс
---
♦ Тип объекта          [["23"]] [[ddl:'Все типы','Subdivision Surface','Клон','Конус','Куб','Ноль','Объект Полигон','Прямоугольник','Сплайн Текст','Сфера'-s200-p1]]
♦ Режим обхода         [["19"]] [[ddl:'Все объекты','Рекурсивно'-s200-p1]]
♦ Рекурсивно начиная с [["5"]]  [[ddl:'Hierarchy Filter','- Примитивы','- Сплайны','- Модификаторы','-- Subdivision Surface','-- Клон'-s200-p1]]
♦ Рекурсивная глубина  [["7"]]  [[tif:'2'-t'0'-s110]]
```-ico-s13
[[ico:'ico/c4d/PLUGIN_CMD_5159.png'-20]] Куб
[[ico:'ico/c4d/PLUGIN_CMD_5160.png'-20]] Сфера
[[ico:'ico/c4d/PLUGIN_CMD_5162.png'-20]] Конус
...
```
---
♦ Метод                [["33"]] [[ddl:'Учета','Исключения'-s200-p2]]
♦ Режим фильтра        [["17"]] [[ddl:'Объект','Тип'-s200-p2]]
```-ico-s13
[[ico:'ico/c4d/PLUGIN_CMD_5140.png'-20]] Примитивы
[[ico:'ico/c4d/PLUGIN_CMD_1018544.png'-20]] Клон
[[ico:'ico/c4d/PLUGIN_CMD_1007455.png'-20]] Subdivision Surface
...
<mdc-n'ChildSelectorTeg'-s450*500>
icon: ico/Var_tools/Tegs/ChildSelectorTeg.png
title: Child Selector Teg
tagline: Добавляет на объект дропдаун выбора прямого дочернего объекта; автоматически обновляет поля «Имя» и «Связь» при смене выбора.
## Пример иерархии
---
```-ico-s13
...
## Интерфейс
---
♦ Объект   [["1"]] [[ddl:'Куб','Сфера','Конус'-s300-p2]]
♦ Имя      [["7"]] [[tif:'Сфера'-s300]]
♦ Связь    [["4"]] [[tif:'Сфера'-p'[[ico:'ico/c4d/PLUGIN_CMD_5160.png']]'-s230]] ▼🧪 
</mdc>

<mdc-n'CameraVisibilityTag'-s450*500>
icon: ico/Var_tools/Tegs/CameraVisibilityTag.png
title: Camera Visibility Tag
tagline: Тег управляет видимостью объекта (вьюпорт + рендер) в зависимости от активной камеры сцены (Stage-объект).
## Пример иерархии
---
```-ico-s13
...
Скрыть при камере
```-ico-s13
[[ico:'ico/c4d/PLUGIN_CMD_1027744.png'-20]] Камера.2 
```
---

Показать при камере
```-ico-s13
[[ico:'ico/c4d/PLUGIN_CMD_1027744.png'-20]] Камера.1 
[[ico:'ico/c4d/PLUGIN_CMD_1027744.png'-20]] Камера.3  
```
---

⚠ Конфликт камер      [["7"]] [[tif:''-s200]]
</mdc>