...
| ------ | ------------------------ | ---------------------------------------------------------- | ------- |
| [[ico:'ico/Var_tools/Animation/shift_anim_to_zero.png']] | **Shift Animation2Zero** | Cдвигает все ключевые кадры сцены так, чтобы анимация начиналась с нужного кадра. | [[photo: -n'UI' -p'image/var_tools/ShiftAnim2Zero.png']] |
| [[ico:'ico/Var_tools/Animation/scale_anim_timeline.png']] | **Scale Animation Timeline** | Масштабирует анимацию и весь таймлайн сцены пропорционально относительно нуля, мгновенно растягивая или сжимая длительность по введённому новому количеству кадров. | [[photo: -n'UI' -p'image/var_tools/ScaleAnimTimeline.png']] |
::::
...
| Значок | Плагин                   | Описание                                                   | Галерея |
| ------ | ------------------------ | ---------------------------------------------------------- | ------- |
| [[ico:'ico/Var_tools/Objects/Primitivs/TriCube.png']] | **Tri Cube** | Генератор куба с 5 типами сетки (треугольники, квады, ёлочка, кирпич, гексагоны), раздельными размерами и подразделениями по XYZ, смещением вершин по нормали и зашивкой швов.| [[photo: -n'Типы' -p'image\var_tools\Objects\Primitivs\TriCube\1.png','image\var_tools\Objects\Primitivs\TriCube\2.png','image\var_tools\Objects\Primitivs\TriCube\3.png','image\var_tools\Objects\Primitivs\TriCube\4.png','image\var_tools\Objects\Primitivs\TriCube\5.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/HexSphere.png']] | **Hex Sphere** | Генератор сферы с настраиваемым числом углов (3–16), радиусом и подразделениями. | [[photo: -n'Типы' -p'image\var_tools\Objects\Primitivs\HexSphere\1.png','image\var_tools\Objects\Primitivs\HexSphere\2.png','image\var_tools\Objects\Primitivs\HexSphere\3.png','image\var_tools\Objects\Primitivs\HexSphere\4.png','image\var_tools\Objects\Primitivs\HexSphere\5.png','image\var_tools\Objects\Primitivs\HexSphere\6.png','image\var_tools\Objects\Primitivs\HexSphere\7.png','image\var_tools\Objects\Primitivs\HexSphere\8.png','image\var_tools\Objects\Primitivs\HexSphere\9.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/DiamondCylinder.png']] | **Diamond Cylinder** | Генератор цилиндра с 4 типами сетки (зигзаг/ромбы, спираль, гармошка, прямая), радиусом, высотой, сегментами, крышками, скруткой по оси и смещением вершин по нормали (звезда).| [[photo: -n'Типы' -p'image\var_tools\Objects\Primitivs\DiamondCylinder\1.png','image\var_tools\Objects\Primitivs\DiamondCylinder\2.png','image\var_tools\Objects\Primitivs\DiamondCylinder\3.png','image\var_tools\Objects\Primitivs\DiamondCylinder\4.png','image\var_tools\Objects\Primitivs\DiamondCylinder\5.png','image\var_tools\Objects\Primitivs\DiamondCylinder\6.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/TriTorus.png']] | **Tri Torus** | Параметрический тор с расширенными возможностями: • Типы поверхности: Квадратная, Треугольная, Спиральная, Диагональная.  • Деформации: Кручение (Twist), Сужение (Taper), Масштаб.  • Смещение поверхности: Нет / Синусоида / Шум Перлина / Радиальное.  • Детальная настройка фонг-сглаживания | [[photo: -n'Типы' -p'image\var_tools\Objects\Primitivs\TriTorus\1.png','image\var_tools\Objects\Primitivs\TriTorus\2.png','image\var_tools\Objects\Primitivs\TriTorus\3.png','image\var_tools\Objects\Primitivs\TriTorus\4.png','image\var_tools\Objects\Primitivs\TriTorus\5.png','image\var_tools\Objects\Primitivs\TriTorus\6.png','image\var_tools\Objects\Primitivs\TriTorus\7.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/BrickPlane.png']] | **Brick Plane** | Плоскость с кирпичной сеткой (паттерны: running bond, stack bond, 1/3 bond, ёлочка, гексагональные, корзинка). Поддерживает швы и displacement по Y. | [[photo: -n'Типы' -p'image\var_tools\Objects\Primitivs\BrickPlane\1.png','image\var_tools\Objects\Primitivs\BrickPlane\2.png','image\var_tools\Objects\Primitivs\BrickPlane\3.png','image\var_tools\Objects\Primitivs\BrickPlane\4.png','image\var_tools\Objects\Primitivs\BrickPlane\5.png','image\var_tools\Objects\Primitivs\BrickPlane\6.png','image\var_tools\Objects\Primitivs\BrickPlane\7.png','image\var_tools\Objects\Primitivs\BrickPlane\8.png','image\var_tools\Objects\Primitivs\BrickPlane\9.png','image\var_tools\Objects\Primitivs\BrickPlane\10.png','image\var_tools\Objects\Primitivs\BrickPlane\11.png','image\var_tools\Objects\Primitivs\BrickPlane\12.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/MolecularHexLattice.png']] | **Molecular Hex Lattice**  | Генератор молекулярных связей. • Материальные теги: M — шары, T — трубки, F — фаски. | [[photo: -n'Превью' -p'image\var_tools\Objects\Primitivs\MolecularHexLattice\1.png','image\var_tools\Objects\Primitivs\MolecularHexLattice\2.png','image\var_tools\Objects\Primitivs\MolecularHexLattice\3.png','image\var_tools\Objects\Primitivs\MolecularHexLattice\4.png','image\var_tools\Objects\Primitivs\MolecularHexLattice\5.png','image\var_tools\Objects\Primitivs\MolecularHexLattice\6.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/Tesseract.png']] | **Tesseract**  | Генератор тессеракта (4D гиперкуб) с проекцией в 3D пространство.  • 16 вершин, 32 ребра, 24 грани, 8 ячеек (кубов) в 4D.  • Поворот в 6 плоскостях 4D пространства (XY, XZ, XW, YZ, YW, ZW).  • Перспективная проекция 4D → 3D.  • Отображение: каркас, рёбра-трубы, вершины, ячейки с прозрачностью.  • Автоматическая анимация вращения. | [[photo: -n'Превью' -p'image\var_tools\Objects\Primitivs\Tesseract\1.png','image\var_tools\Objects\Primitivs\Tesseract\2.png']] |
| [[ico:'ico/Var_tools/Objects/Primitivs/Diamond.png']] | **Diamond**  | Параметрический драгоценный камень с несколькими видами огранки. | [[photo: -n'Огранки' -p'image\var_tools\Objects\Primitivs\Diamond\Asscher.png','image\var_tools\Objects\Primitivs\Diamond\Brilliant.png','image\var_tools\Objects\Primitivs\Diamond\Brilliant2.png','image\var_tools\Objects\Primitivs\Diamond\Cushion.png','image\var_tools\Objects\Primitivs\Diamond\Emerald.png','image\var_tools\Objects\Primitivs\Diamond\Heart.png','image\var_tools\Objects\Primitivs\Diamond\Marquise.png','image\var_tools\Objects\Primitivs\Diamond\Oval.png','image\var_tools\Objects\Primitivs\Diamond\Pear.png','image\var_tools\Objects\Primitivs\Diamond\Princess.png','image\var_tools\Objects\Primitivs\Diamond\Rose.png','image\var_tools\Objects\Primitivs\Diamond\Trillion.png']] |
