...
| - | - | [[ico:'image/var_tools/ShiftAnim2Zero.png'-300]] |
| [[ico:'ico/Var_tools/Animation/scale_anim_timeline.png']] | **Scale Animation Timeline** | Масштабирует анимацию и весь таймлайн сцены пропорционально относительно нуля, мгновенно растягивая или сжимая длительность по введённому новому количеству кадров.    |
| - | - | [[ico:'image/var_tools/ScaleAnimTimeline.png'-300]] |
::::
