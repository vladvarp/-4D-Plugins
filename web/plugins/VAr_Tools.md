...
| [[ico:'ico/Var_tools/Objects/Primitivs/Tesseract.png']] | **Tesseract**  | Генератор тессеракта (4D гиперкуб) с проекцией в 3D пространство.  • 16 вершин, 32 ребра, 24 грани, 8 ячеек (кубов) в 4D.  • Поворот в 6 плоскостях 4D пространства (XY, XZ, XW, YZ, YW, ZW).  • Перспективная проекция 4D → 3D.  • Отображение: каркас, рёбра-трубы, вершины, ячейки с прозрачностью.  • Автоматическая анимация вращения. |
| [[ico:'ico/Var_tools/Objects/Primitivs/Diamond.png']] | **Diamond**  | Параметрический драгоценный камень с несколькими видами огранки. |
