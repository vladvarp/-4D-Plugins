...
PLUGIN_ID   = 1068826
PLUGIN_NAME = "Drop2Floor v1.3.1"
PLUGIN_HELP = "Опустить выделенные объекты на уровень пола (Y = 0)"


# ─── Встроенная иконка (base64 PNG 32×32) ────────────────────────────────────
_ICON_B64 = (
    ""
)
